        ...
        <div className="feature-icons">
          ...
          <div className="feature-card">
            <div className="feature-icon emergency-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#FF5722" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
